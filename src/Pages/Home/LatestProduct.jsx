  ...
  return (
    <div className="md:mt-28 mt-16 md:w-[80%] mx-auto gap-5 px-3">
      ...
      <div className="flex justify-between text-left">
        <div>
          <h2 className="text-[22px] font-[600] text-left">Latest Products</h2>
          {/* Divider */}
      ...
      <div className="mb-20 col-span-9 mx-auto grid grid-cols-1 md:grid-cols-4 gap-x-5 gap-y-10">
        {products.slice(0, 4).map((product) => (
          <>
            <div className="relative grid grid-cols-1 gap-1 rounded-tl-md rounded-tr-md rounded-br-sm rounded-bl-sm">
              <div className="">
                {/*===============CART AND WISHLISH BUTTON============= */}
                <div className="absolute top-[15px] right-[0px] w-[40px] flex flex-col gap-1">
                  <svg
                    ...
                    stroke="currentColor"
                    data-slot="icon"
                    className="w-[29px] h-[29px] bg-[#eee] opacity-25 hover:opacity-80  rounded-full p-1 cursor-pointer"
                  >
                    <path
...
export default React.memo(LatesProduct);
