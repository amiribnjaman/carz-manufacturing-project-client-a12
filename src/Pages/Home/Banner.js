            ...
            <div className='relative banner-section -z-20'>
                <div className='banner-image-box absolute mb-2 text-white'>
                    <div>
                        ...
                        <h1 className='text-xl md:text-4xl text-[#fff] font-bold'>We Believe in Quality</h1>
                        <p>Our supreme objective is to provide the best Quality Products. </p>
                        <button className='px-8 py-2 cursor-pointer hover:bg-[#00CCBD] text-white border border-[#fff] mt-6 '>Explore More</button>
                    </div>
                </div>
            </div>
        </div>
