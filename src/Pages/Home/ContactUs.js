    ...
    return (
      ...
      <div className="col-span-4 text-left">
        ...
        <div className="text-left text-sm mt-10 w-full mr-auto">
          ...
          If You have any query you can direct message to us. Our Customer care operator 24/7 ready to response you and ensure to get you the best services.
          </h4>
      ...
      <div className="col-span-8">
                <form className='w-full' action="">
                 ...
                 <div className='mb-4 flex'>
                     <input type="text" placeholder='Your Name' className='w-full md:w-[80%] ml-auto border-0 border-b focus:border-gray-700' />
                 </div>
                 <div className='mb-4 flex'>
                     <input type="text" placeholder='Your Email' className='w-full md:w-[80%] ml-auto border-0 border-b focus:border-gray-700' />
                 </div>
                 <div className='flex '>
