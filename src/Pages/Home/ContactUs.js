        ...
        <div className='contact-section mt-40 mb-10 text-left w-9/12 mx-auto'>
            ...
            <div className='grid md:grid-cols-2 gap-3 mt-10'>
                <form action="">
                    ...
                    <div className='mt-3'>
                        <button type="button" class="text-white bg-blue-600 hover:bg-blue-700  focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none">Send Message</button>
                    </div>
                </form>
