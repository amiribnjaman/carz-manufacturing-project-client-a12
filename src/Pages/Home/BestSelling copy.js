...
const products = () => {
  ...
  return (
    <div className="mt-28 w-[80%] mx-auto grid grid-cols-12 gap-5 px-3">
      ...
      {parts.length <= 0 ? <ComponentLoading /> : ""}
          ...
          {/*  */}
      <div className="mb-20 col-span-9 mx-auto grid grid-cols-1 md:grid-cols-3 gap-x-5 gap-y-10">
        {parts.map((part) => (
          <>
              ...
              <div className="text-center py-2">
                ...
                <div className="flex mx-1.5 justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <button
                      ...
                      className=" border rounded-full px-4 py-1 bg-gray-200 text-[13px] text-gray-600 hover:bg-gray-700 hover:text-white"
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                              ...
                              <h4 className="flex justify-between text-[15px]">
                                ...
                                <span>
                                  <div class="flex items-center mb-5">
                                    ...
                                    <p class="ml-2 text-[13px] font-bold text-gray-900 dark:text-white">
                                      (4.95)
                                    </p>
                                  </div>
                                </span>
                          ...
                          <div class="flex items-center justify-center px-6 py-3 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                            <button
                              ...
                              data-modal-toggle="defaultModal"
                              type="button"
                              class="rounded-full px-8 py-2 bg-green-400 text-white hover:bg-green-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium text-sm text-center"
                            >
                              Buy Now
                            </button>
                            <button
                ...
                <div className="mx-auto text-center w-full flex justify-center gap-1 mt-4 mb-1">
                  <button
                    ...
                    className="w-2/3 mx-auto rounded-full px-5 py-1 bg-green-400 text-white"
                  >
                    Buy Now
                  </button>
                </div>
