...
const TopNav = () => {
    ...
    return (
        <div className=' hidden md:grid md:grid-cols-3 border-gray-200'>
            <div className='bg-white md:col-span-1'>
                
            </div>
            <div className='col-span-2'>
            <nav id='top-navbar' class="bg-[#014E9C] text-white mx-auto px-2 sm:px-4 py-2.5 dark:bg-gray-800">
                <div class="container pl-8 pr-32 flex flex-wrap justify-between items-center mx-auto">
                    {/* <div className='flex text-[13px] items-center'>
                        ...
                        <div>
                            <h6 className='text-xs'>Connect with us - We are now on social media's</h6>
                    </div>
                    <div class="hidden justify-between items-center w-full md:flex md:w-auto" id="mobile-menu-2">
                        <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
                            <li>
                                <a href="#" class="block py-2 pr-4 pl-3 md:text-white hover:text-blue-700 rounded md:bg-transparent  md:p-0 dark:text-white" aria-current="page">
                            ...
                            <li>
                                <a href="#" class="block py-2 pr-4 pl-3 hover:text-green-700 border-b border-gray-100 text-white  md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
