...
//     useEffect(() => {
//         if (price) {
//             fetch('https://carz-manufacturing-project-server-a12.vercel.app/create-payment-intent', {
//                 method: 'POST',
//                 headers: {
...
//             fetch(`https://carz-manufacturing-project-server-a12.vercel.app/order/${_id}`, {
//                 method: 'PATCH',
//                 headers: {
//                     'content-type': 'application/json'
//                 },
