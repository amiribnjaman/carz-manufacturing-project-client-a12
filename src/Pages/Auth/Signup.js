...
const Signup = () => {
  ...
  useEffect(() => {
    if (creatingError?.code === "auth/email-already-in-use") {
      setCustomSignupError(
        <p className="text-[13px] text-center text-red-500 font-semibold">
  ...
  return (
    <div className="signup-page md:pt-10 pt-20">
      ...
      {/*  */}
      <div className="w-11/12 mx-auto md:pt-0 pt-4 md:flex relative">
        {/*==================== WELCOME MESSAGE========== */}
        <div className="md:w-1/2  md:mt-28 flex justify-start flex-col">
          <h2 className="font-semibold text-[32px] text-white">
            Welcome to <span className="text-[#014E9C] ">thecarZ</span>
          </h2>
          <p className="text-[#eeeeee] text-[11px] w-[75%] mx-auto">
            thecarZ is a car manufacturing company. We provide best cars in the
            world. For get our best please signup.
          </p>
        </div>
        <div className="md:w-1/2 ">
          <div class="p-6 max-w-md grid grid-cols-1 gap-3 bg-white rounded-lg border border-gray-200 shadow-lg z-50">
            <h2 className="text-xl font-semibold text-[#014E9C]">Signup</h2>
