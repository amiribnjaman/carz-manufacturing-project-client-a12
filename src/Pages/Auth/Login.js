            ...
            <div className='w-11/12 mx-auto flex'>
                ...
                <div className='w-1/2 '>
                    <div class="p-6 max-w-md grid grid-cols-1 gap-3 bg-white rounded-lg border border-gray-200 shadow-md">
                        ...
                        <p className=' text-left'><small className=''>New to carZ? <Link to='' className='text-blue-600'>Signup</Link></small></p>
                        ...
                        <button type="button" class="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-900 hover:text-white focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2">SIGNIN WITH GOOGLE</button>
